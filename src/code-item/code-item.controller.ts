...
export class CodeItemController {
    ...
    @ApiResponse({ status: 201, description: 'The code item has been successfully created.', type: CodeItem })
    ...
    @ApiParam({ name: 'code', description: 'The code associated with the Code entity' })
    @ApiParam({ name: 'key', description: 'The key associated with the CodeItem entity' })
    @ApiResponse({ status: 200, description: 'Successfully retrieved the code item.', type: CodeItem })
